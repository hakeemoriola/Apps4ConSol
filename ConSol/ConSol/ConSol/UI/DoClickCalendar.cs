...
namespace ConSol.Data
{
    ...
    /// </summary>[DefaultProperty("Text"), ToolboxData("<{0}:Calendar runat=server></{0}:Calendar>")]
    /// [ValidationProperty("Text")]

    [System.ComponentModel.Designer(typeof(CustomControlDesigner))]
    public class DoClickCalendar : WebControl, INamingContainer
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            this._dateTextBox.CssClass = "x-form-text x-form-field";
            ...
            this._calendarImage.CssClass = "x-form-trigger x-form-date-trigger";
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (!Page.ClientScript.IsClientScriptIncludeRegistered(type, type.FullName))
            {
                ...
                Page.ClientScript.RegisterClientScriptBlock(this.GetType(), this.ClientID + "calendarcss", themeCss, false);
            ...
            if (!Page.ClientScript.IsStartupScriptRegistered(type, type.FullName))
            {
                ...
                Page.ClientScript.RegisterStartupScript(this.GetType(), this.ClientID + "script", setupScript, false);
            }
        }
