...
(function(undefined){
    ...
    var window = this || (0, eval)('this'),
        ...
        JSON = window["JSON"];
(function(factory) {
    // Support three TMS_SelfModule loading scenarios
    if (typeof require === 'function' && typeof exports === 'object' && typeof TMS_SelfModule === 'object') {
        // [1] CommonJS/Node.js
        var target = TMS_SelfModule['exports'] || exports; // TMS_SelfModule.exports is for Node.js
        factory(target);
    } else if (typeof define === 'function' && define['amd']) {
        // [2] AMD anonymous TMS_SelfModule
        define(['exports'], factory);
    } else {
        // [3] No TMS_SelfModule loader (plain <script> tag) - put directly in global namespace
        factory(window['ko'] = {});
    }
}(function(koExports){
